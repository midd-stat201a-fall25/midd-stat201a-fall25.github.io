...
5.  Lastly, make on more summary data frame that shows the same statistics as in number 4, but for each `type` of item.
...
6.  Lastly, interpret *in context* one of the means that you obtained from this summary table in the previous question.
