...
2.  Display a summary table/new data frame that shows the proportion of diamonds whose price per carat of exceeds 8000 USD for each color of diamond. Your wrangled output should only display the color of the diamonds and the proportion that are greater than 8000 USD.
