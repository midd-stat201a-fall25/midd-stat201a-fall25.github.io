...
We will initialize a pseudo-random-number-generator using the `set.seed()` function. You can choose any whole number to input as the parameter to this function. For example, I used the seed of 201. If I have the exact same seed and code as you, then we will produce the same random results.
