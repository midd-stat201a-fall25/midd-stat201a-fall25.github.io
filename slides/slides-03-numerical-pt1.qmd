...
df_positive <- data.frame(
  x = 1:100,
  y = 1:100 + rnorm(100, mean = 0, sd = 25)  # y increases with x
)

# Negative association
x_vals <- seq(50, 100, length.out = 100)
df_negative <- data.frame(
  x = x_vals,
  y = -0.05 * x_vals^2 + 5 * x_vals + rnorm(100, mean = 0, sd = 5)
)

# Create data for no association
df_none <- data.frame(
  x = 1:100,
  y = rnorm(100, mean = 50, sd = 15)  # y is random
)

# Plot 1: Positive Association
p1 <- ggplot(df_positive, aes(x = x, y = y)) +
  geom_point(color = "blue") +
  # ggtitle("Positive Association") +
  theme_minimal()+
  theme(axis.text = element_blank())

# Plot 2: Negative Association
p2 <- ggplot(df_negative, aes(x = x, y = y)) +
  geom_point(color = "red") +
  # ggtitle("Negative Association") +
  theme_minimal()+
  theme(axis.text = element_blank())

# Plot 3: No Association
p3 <- ggplot(df_none, aes(x = x, y = y)) +
...
2.  Convince yourselves as a group: what does a case represent in this data?
