...
Customers are standing in line at a bank. Let $X_{i}$ represent the service time for customer $i$.
...
**Write down probability of interest**
...
-   What is the sampling distribution? \vspace{3cm}

-   What is the value of the probability of interest?
...
-   What does CLT give us? \vspace{3cm}

-   Construct CI \vspace{5cm}
