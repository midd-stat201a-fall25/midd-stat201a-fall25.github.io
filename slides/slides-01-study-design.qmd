...
-   Optional reading: [Chapter 2 Study Design](https://openintro-ims.netlify.app/data-design) from OpenIntro textbook
...
-   In 1936, Franklin D. Roosevelt (Democrat) was running for re-election as president again Alfred Landon (Republican)

-   *Literary Digest* magazine conducted a survey which received 2.4 million respondents (largest number of people every replying to a poll at that time)
