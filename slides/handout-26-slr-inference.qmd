...
::: {layout-ncol="2"}
**If instead** $H_{A}: \beta_{1} > 0$, what code would you use for p-value? $\quad$

**If instead** $H_{A}: \beta_{1} < 0$, what code would you use for p-value?
:::
