...
-   $H_{0}:$ the blood thinner treatment has no effect on survival after heart attack (blood thinner and survival are independent)

-   $H_{A}:$ the blood thinner treatment has an effect on survival after heart attack (blood thinner and survival are dependent)
