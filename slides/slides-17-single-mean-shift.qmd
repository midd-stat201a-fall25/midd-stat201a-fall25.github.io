...
We will use the the data I collected from you about average hours of sleep per night. I know most college students don't receive the recommended 8 hours of sleep. But what about 7.5 hours?

```{r echo = F}
mu0 <- 7.5
```

-   Before we look at the data, we should form our hypotheses. Suppose I am interested in learning if Middlebury students who have an 8:15am class get at least 7.5 hours of sleep (on average).
...
-   Since the alternative is two-sided, we need to be more careful about the p-value calculation
