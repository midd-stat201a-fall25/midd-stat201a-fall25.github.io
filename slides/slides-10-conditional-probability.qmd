...
-   But oftentimes we have to use data to try and estimate probabilities
    ...
    -   Use proportions from randomly sampled data as a proxy
...
2.  $\text{P}(A \cap B)$ is an example of a **joint probability**, which is a probability involving two or more events that occur simultaneosly
