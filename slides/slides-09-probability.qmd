...
-   That is, if $A$ and $B$ are disjoint, then $\text{Pr}(A \cap B) = \emptyset$
...
1.  If I randomly sample one of the voters, what is the probability that they are...
    i.  Independent but not a swing voter?
    ii. Independent or a swing voter?
    iii. Neither Independent nor swing voters?
