...
-   Render as a beautiful table, not a data frame. The probabilities should be up to 3 decimal points. To do this, look at the last slide of the Simpson's paradox slide deck on the course website.
...
5.  Re-create your first visualization from Exercise 1, this time bringing in your new `age_cat` variable in an appropriate way. Make sure you have informative labels and titles, and use the same color choice as you did in Exercise 1.
...
-   Render as a beautiful table, not a data frame, with probabilities up to three decimal points.
