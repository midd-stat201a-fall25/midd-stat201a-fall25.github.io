...
-   **What**: content through end of Week 10 (i.e. through Simple Linear Regression)
    ...
    -   ::: {style="color: purple"}
        You will be provided a table [z](z_table.pdf), [t](t_table.pdf), and [$\chi^2$](chi_square_table.pdf) table. Familiarize yourself with them by watching [this video](https://middlebury.zoom.us/rec/share/IiwdvdjN0aIS5c4g9AZdhWGQBTtc0E5zCuTkvOGbvsU2Vi5nlDqZHrg9jh2w8Iqm.Q2fdej1_aHJnqNKX%20Passcode:%204es%5E$9F8) (password: 4es\^\$9F8). Feel free to ask Prof. Tang questions about how to use them prior to the midterm!
        :::
...
-   Extra practice problems are available [here](midterms/midterm2_practice_probs.pdf).
    -   Suggested solutions [here](midterms/midterm2_practice_probs_solns.pdf)
