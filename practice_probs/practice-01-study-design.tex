...
\item
  ...
  Of the 90\% of students who responded, the average time spent on the
  course was found to be 10.2 hours per week.

  Based on this information, identify which of the following correspond
  to a: case, variable, parameter, and statistic.
  ...
  \item
    10.2 hours
  \item
    The average number of hours spent on the course of all STAT 311
    students from Spring 2024
  \item
    A STAT 311 student
  \item
